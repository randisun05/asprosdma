                                                ...
                                                <form @submit.prevent="submit" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row py-2 ms-2">
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="form-group mt-1 mb-4">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Masukan Perihal/Nomor Surat"
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="form-group mt-1 mb-4">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Masukan NIP Penandatangan" v-model="form.nipttd">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="form-group mt-1 mb-4">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Masukan NIP Paraf" v-model="form.nipparaf">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="form-group mt-1 mb-4">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Masukan Tujuan Instansi" v-model="form.tujuan">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="form-group mt-1">
                                                                <input type="file" class="form-control"
                                                                    placeholder="Masukan Gambar/Foto" @change="updateDocument"
                                                                    accept=".pdf">
                                                            </div>
