          ...
          <div class="collapse navbar-collapse" id="xenav">
            <ul class="navbar-nav ms-auto">
               ...
               <li class="nav-item dropdown">
                  <a class="nav-link pagescroll dropdown-toggle" data-bs-toggle="dropdown" href="#keanggotaan" role="button" aria-expanded="false">Profile</a>
                  <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/registration">Tentang Aspro</a></li>
                        <li><a class="dropdown-item" href="/login">Ketua Umum</a></li>
                        <li><a class="dropdown-item" href="/login">Struktur Organisasi</a></li>
                        <li><a class="dropdown-item" href="/login">Visi Misi</a></li>
                        <li><a class="dropdown-item" href="/login">Sejarah Terbentuknya Aspro</a></li>
                        <li><a class="dropdown-item" href="/login">Peraturan Organisasi</a></li>
                     </ul>
               </li>
               <li class="nav-item dropdown">
                  <a class="nav-link pagescroll dropdown-toggle" data-bs-toggle="dropdown" href="#keanggotaan" role="button" aria-expanded="false">Program</a>
                  <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/registration">Pelatihan</a></li>
                        <li><a class="dropdown-item" href="/login">Sertifikasi</a></li>
                        <li><a class="dropdown-item" href="/login">Kegiatan Aspro</a></li>
                     </ul>
               </li>
               <li class="nav-item dropdown">
                  <a class="nav-link pagescroll dropdown-toggle" data-bs-toggle="dropdown" href="#keanggotaan" role="button" aria-expanded="false">Publikasi</a>
                  <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/registration">Pengumuman</a></li>
                        <li><a class="dropdown-item" href="/login">Artikel</a></li>
                        <li><a class="dropdown-item" href="/login">Berita</a></li>
                        <li><a class="dropdown-item" href="/login">Media</a></li>
                     </ul>
               </li>
               <li class="nav-item dropdown">
      ...
      <div class="inner-wrapper">
         ...
         <nav class="side-nav">
            <ul class="navbar-nav w-100">
               ...
               <li class="nav-item">
                  <a class="nav-link pagescroll" href="#our-feature">profile</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link pagescroll" href="#our-team">Program</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link pagescroll" href="#portfolio-xe">Publikasi</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link pagescroll" href="#our-pricings">Keanggotaan</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link pagescroll" href="#our-testimonial">kontak Kami</a>
               </li>
            </ul>
         </nav>
...
<div id="rev_arrows" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
   <ul>	<!-- SLIDE  -->
      ...
      <!-- SLIDE  -->
      <li data-index="rs-second" data-transition="fadetotopfadefrombottom" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500"  data-thumb="/assets/images/7a.jpg">
      <!-- MAIN IMAGE -->
      ...
      <!-- SLIDE  -->
      <li data-index="rs-third" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="/assets/images/9a.jpg">
      <!-- MAIN IMAGE -->
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-6 col-sm-7 text-md-start text-center wow fadeInLeft" data-wow-delay="300ms">
            ...
            <a href="#our-team" class="button btnsecondary pagescroll">Daftar Sekarang</a>
         </div>
         <div class="col-md-6 col-sm-5 wow fadeInRight" data-wow-delay="300ms">
            <div class="image top50"><img alt="SEO" src="/assets/images/14a.jpg"></div>
         </div>
      </div>
   </div>
</section>
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 text-center">
            <div class="heading-title wow fadeInUp" data-wow-delay="300ms">
               <h2 class="whitecolor">Proses <span class="fontregular">Registrasi</span> </h2>
            </div>
         </div>
      </div>
      <div class="row">
         <ul class="process-wrapp">
            <li class="whitecolor wow fadeIn" data-wow-delay="300ms">
               ...
               <p class="fontbold bottom25">Web</p>
               <p>Akses Halamam Registrasi</p>
            </li>
            ...
            <li class="whitecolor wow fadeIn" data-wow-delay="600ms">
               ...
               <p class="fontbold bottom25">Verifikasi</p>
               <p>Menunggu Hasil Verifikasi Data</p>
            </li>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-8 offset-md-2 col-sm-12 text-center">
            <div class="heading-title wow fadeInUp" data-wow-delay="300ms">
               <span>Publikasi</span>
               <h2 class="darkcolor bottom20">Publikasi</h2>
   ...
   <div class="container">
    <div class="row">
         <div class="col-md-8 offset-md-2 col-sm-12 text-center">
            <div class="heading-title wow fadeInUp" data-wow-delay="300ms">
               <span>Media</span>
               <h3 class="darkcolor bottom10">Munas Asosiasi Profesi Jabatan Fungsional SDM Aparatur</h3>
               <p class="heading_space">Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed suscipit. Vestibulum auctor nunc vitae diam eleifend, in maximus metus sollicitudin. Quisque vitae sodales lectus. Nam porttitor justo sed mi finibus, vel tristique risus faucibus. </p>
      ...
      <div id="flat-gallery" class="cbp">
         <div class="cbp-item web logo">
            ...
            <div class="overlay center-block whitecolor">
               <a class="plus" data-fancybox="gallery" href="/assets/images/1a.jpg"></a>
         ...
         <div class="cbp-item graphic print">
            ...
            <div class="overlay center-block whitecolor">
               <a class="plus" data-fancybox="gallery" href="/assets/images/6a.jpg"></a>
               <h4 class="top30">Wood Work</h4>
               <p>Small Portfolio Detail Here</p>
            </div>
         </div>
         <div class="cbp-item logo graphic">
            <img src="/assets/images/7a.jpg" alt="">
            <div class="overlay center-block whitecolor">
         ...
         <div class="cbp-item print">
            <img src="/assets/images/8a.jpg" alt="">
            <div class="overlay center-block whitecolor">
         ...
         <div class="cbp-item logo">
            <img src="/assets/images/10a.jpg" alt="">
            <div class="overlay center-block whitecolor">
         ...
         <div class="cbp-item web print graphic">
            <img src="/assets/images/11a.jpg" alt="">
            <div class="overlay center-block whitecolor">
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 text-center">
            <div class="heading-title wow fadeInUp" data-wow-delay="300ms">
               ...
               <h2 class="darkcolor heading_space">Applications</h2>
            </div>
         </div>
      </div>
...
<!-- <section id="funfacts" class="padding_top fact-iconic gradient_bg">
   <div class="container">
      <div class="row">
         <div class="col-md-5 col-sm-12 margin_bottom whitecolor text-md-start text-center wow fadeInUp" data-wow-delay="300ms">
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-5 col-sm-12">
            <div class="image hover-effect"><img src="/assets/images/14a.jpg" alt="our blog" class="equalheight"></div>
         </div>
         <div class="col-md-7 col-sm-12">
            <div class="split-box center-block equalheight container-padding">
               <div class="heading-title padding_half">
               <span class="wow fadeIn" data-wow-delay="300ms">Merchandise</span>
               <h2 class="darkcolor bottom25 wow fadeIn" data-wow-delay="350ms">Merchandise</h2>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
           <div class="heading-title heading_space wow fadeInUp" data-wow-delay="300ms">
               <span>Lebih Dekat Dengan Aspro</span>
               <h2 class="darkcolor">Kontak</h2>
            </div>
        </div>
